...
import com.example.app_titulacion.data.http.response.NotificationAcosoSexualResponse
import com.example.app_titulacion.data.http.response.NotificationAgresionFisicaResponse
import com.example.app_titulacion.data.http.response.NotificationAgresionVerbalResponse
